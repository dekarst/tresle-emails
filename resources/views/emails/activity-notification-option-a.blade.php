                                                    ...
                                                    <tr>
                                                        <td style="padding: 0 0 26px;" class="mobile-padding-bottom-19">
                                                            <table align="left" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="font-size: 16px; line-height: 24px; color: #8DA3B7; padding: 13px 20px 21.37px 30px; border: 1px solid #EAEDF3; border-left: 3px solid #249318; border-radius: 0 4px 4px 0; background-color: #FFFFFF; box-shadow: 0 1px 3px 0 rgba(0,0,0,0.04);" class="stack-column-center">
                                                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td width="19%"><span style="color: #1C486F; font-size: 26px; letter-spacing: 0; line-height: 38px;">2</span></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="padding: 0 0 15.1px;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="41%">
                                                                                            <a href="#" style="font-size: 12px; font-weight: 600; line-height: 16px; text-decoration: none; color: #249318; text-transform: capitalize;">View My Requests</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        ...
                                                                        <td style="font-size: 16px; line-height: 24px; color: #8DA3B7; padding: 13px 20px 21.37px 30px; border: 1px solid #EAEDF3; border-left: 3px solid #249318; border-radius: 0 4px 4px 0; background-color: #FFFFFF; box-shadow: 0 1px 3px 0 rgba(0,0,0,0.04);" class="stack-column-center">
                                                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td width="19%"><span style="color: #1C486F; font-size: 26px; letter-spacing: 0; line-height: 38px;">1</span></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="padding: 0 0 15.1px;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="41%">
                                                                                            <a href="#" style="font-size: 12px; font-weight: 600; line-height: 16px; text-decoration: none; color: #249318; text-transform: capitalize;">Read My Message</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                        </td>
                                                                        <td style="font-size: 16px; line-height: 24px; color: #8DA3B7; padding: 13px 20px 21.37px 30px; border: 1px solid #EAEDF3; border-left: 3px solid #029BDC; border-radius: 0 4px 4px 0; background-color: #FFFFFF; box-shadow: 0 1px 3px 0 rgba(0,0,0,0.04);" class="stack-column-center">
                                                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td width="19%"><span style="color: #1C486F; font-size: 26px; letter-spacing: 0; line-height: 38px;">2</span></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="41%">
                                                                                            <a href="#" style="font-size: 12px; font-weight: 600; line-height: 16px; text-decoration: none; color: #029BDC; text-transform: capitalize;">View My Matches</a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
